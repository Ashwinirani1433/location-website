...
let ip_address = null;
function getIP() {
  fetch("AIzaSyDx8ZSXryqN2YKUSNBb84TIUJqmDN1JcYo")//AIzaSyDx8ZSXryqN2YKUSNBb84TIUJqmDN1JcYo
  ...
  dataDiv.innerHTML += `
   ...
   <nav>
        ...
        <div class="map">
          ...
          <iframe
          src="https://maps.google.com/maps?q=26.8396695,80.8523141&z=15&output=embed"
          frameborder="0"
          id="mapFrame"
        ></iframe>
        </div>
